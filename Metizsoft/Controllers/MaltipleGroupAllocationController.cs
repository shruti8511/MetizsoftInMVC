...
{
    public class MaltipleGroupAllocationController : Controller
    {
        // GET: GroupAllocation
        ...
        public MaltipleGroupAllocationController(IGroup IGroup, IProduct IProductservice, IDoctor IDoctorService, IRetail IRetailService)
        {
            _IGroup = IGroup;
        ...
        public ActionResult Index()
        {
            ...
            {
                ViewBag.ProductGroup = _IGroup.SelectGroupTypeForProduct();
        ...
        public PartialViewResult MultipleGroupAlloctionlist(long GroupType = 0)
        {
            List<MultipleGroup_MstModel> lstEntity = new List<MultipleGroup_MstModel>();
            lstEntity = _IGroup.MultipleGetAlloctedList(GroupType);
        ...
        {
            List<Group_Mst> lstGroup = _IGroup.SelectGroup(1);
        ...
        public JsonResult SaveAllocatedGroup(long GroupID, long GroupTypeID, long ToAllocateID , long? ID)
        {
            try
            {
                if (ToAllocateID != 0)
                {
                    MultipleAllocation objAllocate = new MultipleAllocation();
                    objAllocate.ID = ID;
                    objAllocate.UserID = ToAllocateID;
                    ...
                    _IGroup.GroupMultipleAllocation(objAllocate);
                }
        ...
        public JsonResult DeleteAlloctionGroup(long GroupID, long GroupTypeID, long AlloctionID)
        {
            try
            {
                bool result = _IGroup.DeleteAlloctionGroup(GroupID, GroupTypeID, AlloctionID);
